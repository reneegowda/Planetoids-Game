...
# speed of the UFO
UFO_SPEED = 2.0
# number of lives the UFO has
UFO_LIVES = 3
# The image file to use for the UFO
UFO_IMAGE = 'ufo.png'
# The image file to use for the UFO with alien
UFOalien_IMAGE = 'ufo-alien.png'
# The alien's bullet rate
ALIEN_RATE = 90
# alien bullet color
ALIEN_COLOR = 'green'
#alien bullet speed
...
STATE_COMPLETE = 5
# state when the welcome screen is up
STATE_WELCOME = 6
### FONT CONSTANTS ###
